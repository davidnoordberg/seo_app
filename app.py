...
def _adapt_url_for_sqlalchemy(url: str) -> str:
    """Pas Postgres URL aan voor SQLAlchemy/pg8000."""
    if not url:
        return ""
...
def save_scan_to_db(name: str, website_url: str | None, description: str | None,
                    location: str | None, language: str | None, score: int, email: str | None) -> bool:
    if not ENGINE:
...
def run_vindbaarheidsscan(bedrijfsnaam: str, description: str, locatie: str,
                          domeinnaam: str | None, n: int = 10, collect: bool = False,
